 ...
 * @author Musica
 */
public class VentanaProductoPeso extends javax.swing.JFrame {
     ...
     */
    public VentanaProductoPeso(Producto producto) {
    ...
    private void initComponents() {
        ...
        registrarPreciosPeso.setText("Registrar");
    ...
    private void registrarPreciosPesoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_registrarPreciosPesoActionPerformed
        ...
        try {
            ...
            if (precioCompraTxt.getText().equals("")
                    ...
                    || precioKiloTxt.getText().equals("")
                    || precioMedioTxt.getText().equals("")
                    || precioCuartoTxt.getText().equals("")
                    || cantidadMayoreoTxt.getText().equals("")
                    || cantidadMedioMayTxt.getText().equals("")) {
                ...
                if (!validInsert) {
                    ...
                    if (!productoDao.insertPreciosProducto(precioProducto, 2)) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaProductoPeso.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VentanaProductoPeso(null).setVisible(true);
